...
abstract class FlutterFlowTheme {
  ...
  late Color correctWithOpacity;
  late Color wrongAnswerBorder;
  late Color wrongAnswerBackground;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color correctWithOpacity = Color(0x42ACC420);
  late Color wrongAnswerBorder = Color(0xFFCC3B3B);
  late Color wrongAnswerBackground = Color(0x42CC3B3B);
}
